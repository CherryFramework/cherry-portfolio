		...
		$metabox_post_settings = apply_filters( 'cherry_portfolio_post_settings_metabox_params', array(
			...
			'callback_args' => array(
				array(
					...
					'description'	=> __( 'Enter a external-link', 'cherry-portfolio' ),
					'value'			=> '',
				),
				array(
			...
			case 'gallery':
				...
				$post_format_settings = apply_filters( 'cherry-portfolio-gallery-format-settings', array(
						...
						array(
							...
							'type'			=> 'slider',
							'label'			=> __('Number slides per view', 'cherry-portfolio'),
							'description'	=> __('Number slides per view', 'cherry-portfolio'),
							'value'			=> 1,
							'max_value'		=> 10,
							'min_value'		=> 1,
						),
						array(
							...
							'description'	=> __('With difine space between slides(px)', 'cherry-portfolio'),
							'value'			=> 10,
							'max_value'		=> 100,
							'min_value'		=> 0,
						),
						array(
							...
							'description'	=> __('Number slides per column', 'cherry-portfolio'),
							'value'			=> 1,
							'max_value'		=> 5,
							'min_value'		=> 1,
						),
			...
			case 'audio':
				...
				$post_format_settings = apply_filters( 'cherry-portfolio-audio-format-settings', array(
						array(
							...
							'description'		=> __('Enter source audio( mp3, m4a, ogg, wav, wma )', 'cherry-portfolio'),
							'value'				=> '',
							'display_image'		=> true,
							'multi_upload'		=> true,
							'library_type'		=> 'audio',
